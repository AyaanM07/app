    ...
    <>
      ...
      >
        <div className='flex justify-between items-center mb-6'>
          <h2 className='text-xl font-semibold text-gray-100' onClick={handleTitleClick}>One Question a Day</h2>
      ...
      {isModalOpen && (
        <DirectoryModal classData={selectedClass} onClose={() => setIsModalOpen(false)} />
      )}
